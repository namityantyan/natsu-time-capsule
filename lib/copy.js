...
export const COPY_FIELDS = [
  ...
  { key: 'scroll_hint', group: 'トップ', label: 'スクロール誘導', def: 'scroll — いつかの自分へ手紙を書く' },
  { key: 'form_heading', group: 'トップ', label: 'フォーム見出し', def: 'いつかの自分への手紙' },
  { key: 'form_intro', group: 'トップ', label: 'フォーム説明', def: 'いまの気持ちを、いつかのあなたへ。投稿は運営の確認後に公開されます。', multiline: true },
  { key: 'deadline_note', group: 'トップ', label: '受付期限の注意書き', def: '手紙の受付は 9月15日（火）23:59 まで。' },
  { key: 'submit_button', group: 'トップ', label: '送信ボタン', def: 'タイムカプセルに保存する' },
  { key: 'notice_text', group: 'トップ', label: '注意書き（個人情報）', def: '安全のため、本名・住所・電話番号・学校名・勤務先など、個人が特定できる情報は書かないでください。' },
  { key: 'letters_title', group: '公開ページ', label: '見出し', def: '誰かのタイムカプセル' },
  { key: 'someone_button', group: '公開ページ', label: '「誰かの手紙を見る」ボタン', def: '誰かの手紙を見る' },
