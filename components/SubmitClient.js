...
import { BODY_MAX, NICKNAME_MAX } from '../lib/config';
import { useCopy } from './CopyProvider';

// トップページの本体。受付中かどうかはサーバー側で判定した値を受け取る（期限や環境変数の変更を即反映・チラつきなし）
export default function SubmitClient({ submissionsOpen = true }) {
        ...
        <section className="section">
          {submissionsOpen ? (
            <form className="panel" onSubmit={onSubmit}>
              ...
              {copy.deadline_note && <p className="deadline">{copy.deadline_note}</p>}
