...
// 公開ページ用：開封後のみ、承認済み・公開OKの手紙（静的に焼き込み済み）を返す
export async function GET(req) {
  const revealed = isRevealed();
  // テスト用プレビュー解錠: PREVIEW_LETTERS=true なら開封前でもポータルを表示できる。
  // ⚠️ 本番の実手紙を集める前に必ず外すこと（付けたままだと開封前に公開手紙が見える）。
